package com.abctechgroup.gateway.security;
...
public class AuthentificationFilter extends BasicAuthenticationFilter {

    private Environment env;

    public AuthentificationFilter(AuthenticationManager authenticationManager, Environment env) {
